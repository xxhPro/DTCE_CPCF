...
parser.add_argument('--conf_thresh', type=float, default=0.93, help='random seed')
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/idea_newal_dual_SPL_LDTCE/093/model/{}_{}/{}_{}".format(
