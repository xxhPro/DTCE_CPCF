...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            writer.add_scalar('info/loss_DTCE', loss_DTC, iter_num)
            ...
            if iter_num <= 12000:
                ...
                if iter_num % 200 == 0:
                    logging.info(
                        'iteration %d : loss : %f, loss_ce: %f, loss_DTCE:%f' %
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/BTCV_dtce_spl_fold4/09/model/{}_{}/{}_{}".format(
