    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            with (torch.amp.autocast(device_type='cuda', dtype=torch.float16)):
                ...
                # soft_pseudo_label = mix_with_scribble(label_batch, soft_pseudo_label, num_classes=args.num_classes)
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/stage2/osw_LDTCE_stage2/model/{}_{}/{}_{}".format(
