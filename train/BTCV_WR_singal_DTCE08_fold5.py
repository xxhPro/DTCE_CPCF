...
parser.add_argument('--conf_thresh', type=float, default=0.8, help='random seed')
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/BTCV_WR_singal_DTCE08_fold5/model/{}_{}/{}_{}".format(
