...
parser.add_argument('--model', type=str,
                    default='unet_3D', help='select mode: unet_cct_dp_3D, \
                        attention_unet_2dual_3d, unetr_2dual_3d')
parser.add_argument('--exp', type=str,
                    default='Fully_3d', help='experiment_name')
parser.add_argument('--fold', type=str,
                    default='stage1', help='train fold name')
parser.add_argument('--sup_type', type=str,
                    default='label', help='supervision type, select mode: label, scribble, pseudoLab')
parser.add_argument('--num_classes', type=int, default=17,
                    help='output channel of network')
parser.add_argument('--max_iterations', type=int,
                    default=30000, help='maximum epoch number to train')
parser.add_argument('--ES_interval', type=int,
                    default=30001, help='maximum iteration iternal for early-stopping')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss_ce = ce_loss(outputs, gt_batch[:].long())
            loss = loss_ce
            ...
            if iter_num > 18000 and iter_num % 200 == 0:
                logging.info(
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/Fully3d_sup2/model/{}_{}/{}_{}_{}".format(
