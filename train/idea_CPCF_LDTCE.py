...
parser.add_argument('--conf_thresh', type=float, default=0.9, help='random seed')
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/idea_newa_dual_SPL_LDTCE/09/model/{}_{}/{}_{}".format(
