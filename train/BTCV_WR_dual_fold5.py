...
parser.add_argument('--data_root_path', type=str,
                    default='/data/hqn_data/Data/BTCV/3D/five_fold/fold5',
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            with (torch.amp.autocast(device_type='cuda', dtype=torch.float16)):
                ...
                loss = 8.0 * loss_pse_sup_soft + loss_ce
            ...
            if iter_num <= 14000:
                ...
                if iter_num % 200 == 0:
                    logging.info(
                        'iteration %d : loss : %f, loss_ce: %f, loss_sps:%f' %
                        (iter_num, loss.item(), loss_ce.item(), loss_pse_sup_soft.item()))
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/BTCV_WR_dual_fold5/model/{}_{}/{}_{}".format(
