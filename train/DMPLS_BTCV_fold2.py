...
parser.add_argument('--data_root_path', type=str,
                    default='/data/hqn_data/Data/BTCV/3D/five_fold/fold2',
...
parser.add_argument('--exp', type=str,
                    default='Weakly_PLS_hard_3d', help='experiment_name')
...
parser.add_argument('--ES_interval', type=int,
                    default=60001, help='maximum iteration iternal for early-stopping')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            pseudo_supervision = torch.argmax((alpha * outputs_soft1.detach() + (1.0 - alpha) * outputs_soft2.detach()),
                                              dim=1, keepdim=False)
            ...
            if iter_num > 40000 and iter_num % 200 == 0:
                logging.info(
...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/hqn_data/Experiment/DMPLS_BTCV_fold2/model/{}_{}/{}_{}_{}".format(
