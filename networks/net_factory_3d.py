...
from networks.attention_unet_feat_2dual import Attention_UNet_feat_2dual
...
def net_factory_3d(net_type="unet_3D", in_chns=1, class_num=2):
    ...
    elif net_type == "attention_unet_feat_2dual_3d":
        net = Attention_UNet_feat_2dual(in_channels=in_chns, n_classes=class_num).cuda()
